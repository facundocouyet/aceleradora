# Aceleradora Cáscara · Documento maestro

**Versión 10 · agosto 2026**
Documento interno de trabajo. Base para cerrar con Franco y para que Teo opere la camada. Los acuerdos económicos y el reparto viven en el documento madre de la fusión y no se repiten acá.

> El pitch al cliente sale de este documento y se diseña aparte, como pieza propia.

---

## 1. Por qué hacemos esto

Cáscara y F3 llegaron al mismo lugar por caminos distintos y hoy le venden lo mismo a la misma persona.

**Cáscara tiene lo más difícil de construir:** comunidad, identidad, autoridad en creatividad, contenido y marca personal. Los estrategas creativos que salen del programa trabajan bien el contenido de sus clientes, con poca estrategia de marketing detrás, y eso les dificulta generar resultados propios para venderse más caro.

**F3 tiene exactamente esa capa:** estrategia de growth, embudos, pauta, diseño de oferta en low, mid y high ticket, y un proceso comercial que cierra. Lo que le falta es la pata de contenido para que la estrategia dé resultado, y la comunidad e identidad que Cáscara ya construyó.

El Founder System y la Aceleradora resuelven el mismo momento del mismo cliente. Sostener los dos es partir la energía en dos calendarios, dos procesos comerciales y dos promesas parecidas. La fusión no inventa un producto nuevo: **junta las dos mitades del que ya teníamos.**

**Tres definiciones que ordenan todo lo demás:**

**Una sola aceleradora, un solo calendario.** El Founder System se discontinúa el día que abre la primera cohorte unificada.
...
## 2. Qué se discontinúa

El Founder System fue un programa de 60 a 90 días, con diagnóstico más sesiones 1-1 semanales, sin instancias grupales, y con Franco y el estratega del área como equipo visible. Se vendió entre USD 2.000 y 4.000 según el grado de personalización de cada acuerdo. Se discontinúa entero.

| | Founder System (discontinuado) | Aceleradora |
|---|---|---|
...
## 3. Dónde vive la Aceleradora dentro de la escalera

| Nivel | Producto | Qué resuelve | Acceso a los founders |
|---|---|---|---|
| 1 | La Cáscara (B2C) | Oficio: identidad, contenido, primera oferta | Grabado |
| 2 | **Aceleradora** | El oficio se vuelve negocio | En vivo, grupal y 1-1 |
| 3 | Growth Partner | Se construye y opera el negocio en conjunto | Socio |
...
> **A confirmar · Teo.** Los dos párrafos que siguen son la versión que veníamos manejando y todavía no están cerrados. El primero, si la palabra evergreen describe lo que estamos haciendo o si conviene sacarla del vocabulario del producto, porque hoy se usa para el modelo de venta y para el formato de entrega al mismo tiempo y confunde a los dos lados. El segundo, si la división de grupales y 1-1 se sostiene ahora que las grupales existen solo en el mes 1. Que Teo defina las dos y se reescriban.
...
|---|---|---|
| **Conseguir** | No le llegan consultas, o llegan y no cierra | Oferta, precio y proceso de venta |
| **Sostener** | Consigue, pero la demanda depende de su energía | Contenido, audiencia y delegación |
| **Entregar** | Consigue y cierra, y la entrega lo consume | Proceso de servicio, capacidad y equipo |

El desarrollo completo está en la sección 6.
...
- Proceso de ventas documentado: prospección, discovery, propuesta, objeciones y seguimiento
- Estructura de entrega de servicio: proceso paso a paso, onboarding de cliente e informes de inicio y cierre
- Dashboard de métricas del embudo completo
- Roadmap a 6 meses, escrito en la última llamada
- Biblioteca de libros, recursos y activos utilizables, con acceso permanente

Es el piso, no el cierre.
...
Cada sesión produce un accionable que es el insumo de la siguiente. Nadie llega a una sesión con la hoja en blanco.

Es la columna vertebral del fulfillment y lo que diferencia esto de un programa de mentorías. La sesión no arranca con "contame cómo venís": arranca con el accionable de la anterior, ejecutado o no. Eso convierte cada instancia en avance verificable y hace que el mentor no tenga que reconstruir contexto.

### El mapa de 1-1

Cuatro llamadas por mes, alternando Facu y Franco, salvo el último mes. La alternancia importa: ninguna persona da dos llamadas seguidas, ni siquiera en el pase de un mes al otro.

| Mes | Semana | Quién | Qué pasa |
|---|---|---|---|
| 1 | 1 | Facu | Clarity · diagnóstico, cuello de botella y prioridad de ataque |
| 1 | 2 | Franco | Producto, servicio, oferta y coordinación del lanzamiento |
| 1 | 3 | Facu | Aterrizaje de lo anterior y **elección de la orientación** |
| 1 | 4 | Franco | Cierre del mes 1 y arranque del servicio |
| 2 | 5 | Franco | Oferta y precio |
| 2 | 6 | Facu | Entrega y estructura, aplicadas a su caso |
| 2 | 7 | Franco | Adquisición y ventas |
| 2 | 8 | Facu | Cierre del mes 2 y ajuste de la orientación |
| 3 | 9 | Franco | Apertura del mes 3 |
| 3 | 11 | Facu | Ejecución sobre la orientación |
| 3 | 13 | Franco | Cierre y roadmap a 6 meses |
...
Dueño: Teo. Arranca dentro de las 48 horas del pago. Todo asincrónico y grabado, salvo el alta en los canales.
...
**¿La demanda depende de su energía?** Va a **Sostener**. Vende, pero cada mes arranca de cero porque nada corre solo.

**¿La entrega lo consume?** Va a **Entregar**. El problema está adentro del servicio, no afuera.

**Si dos aplican**, gana la que está bloqueando a la otra. Sostener no rinde si no cierra, y Entregar no rinde si no tiene a quién entregarle: por eso el orden es Conseguir, después Entregar, después Sostener. El criterio se escribe en su documento de recorrido, para que ningún founder lo discuta después.
...
Todos los pasan y todos entregan el mismo piso. Lo que cambia con la orientación es cuántas llamadas se le dedican a cada uno.

| Bloque | Quién | Entregable mínimo, para todos |
|---|---|---|
| Contenido y audiencia | Arranca con Fede y Juana en el mes 1 | Calendario propio publicándose |
| Oferta y precio | Franco | Oferta escrita con precio y niveles |
| Adquisición y ventas | Franco | Proceso de venta con propuestas enviadas |
...
| | **Conseguir** | **Sostener** | **Entregar** |
|---|---|---|---|
| Cuello de botella | No le llegan consultas, o llegan y no cierra | Consigue, pero depende de su energía para generar demanda | Consigue y cierra, la entrega lo consume |
| Profundiza en | Oferta, precio y proceso de venta | Contenido, audiencia y delegación de la producción | Proceso de servicio, capacidad y equipo |
| Objetivo de 60 días | Primeros cierres con el sistema nuevo | Ritmo de contenido sostenido sin depender de él | Entregar el mismo servicio con menos horas propias |
| Métrica que mira | Propuestas enviadas y cierres | Piezas publicadas y consultas entrantes | Horas propias por cliente y margen |

#### Dónde vive la orientación
...
| # | Tema |
|---|---|
| 1 | Bienvenida, setup y cómo se recorre el programa |
| 2 | Tu semana real: dónde se te va el tiempo |
| 3 | Herramientas y sistemas mínimos para operar |
| 4 | Entregar el servicio sin depender de vos en cada tarea |
...
| # | Tema |
|---|---|
| 1 | A quién le hablás y con qué mundo |
| 2 | Identidad visual y criterio propio |
| 3 | Taller sobre piezas propias |
...
| # | Tema |
|---|---|
| 1 | Línea editorial y ángulos propios |
| 2 | Formatos y guionado |
| 3 | Taller sobre el calendario ejecutado |
...
|---|---|---|---|
| Revisa | El sistema que produce: quién hace qué, en cuánto tiempo, con qué herramientas | Las piezas: criterio visual, identidad, si se parecen a él o a cualquiera | El calendario: si está actualizado, si se está cumpliendo, si lleva a algo |
| Pregunta típica | ¿Esto lo podés sostener el mes que viene sin vos? | ¿Esto se distingue de lo que ya hay? | ¿Esta pieza a dónde lleva? |
...
Cada ítem del checklist tiene un espacio donde se trabaja y uno donde se valida.

| Bloque | Se trabaja en | Se valida en |
|---|---|---|
| Contenido y audiencia | Grupales de Juana y Fede | Grupal, con el repaso de ejecución |
| Oferta y precio | 1-1 con Franco | 1-1 |
| Adquisición y ventas | 1-1 con Franco | 1-1 |
| Entrega del servicio | Grupal de Teo | 1-1 con Facu |
| Estructura, capacidad y números | Grupal de Teo | 1-1 con Facu |
...
**Mes 1**
- [ ] Formulario inicial completo dentro de las 48 horas
- [ ] Accesos activos y calendario cargado
- [ ] Diagnóstico y prioridad de ataque (S1, Facu)
- [ ] A quién le habla y con qué mundo (Juana)
- [ ] Calendario de contenido a 30 días (Fede)
- [ ] Oferta, servicio y coordinación del lanzamiento (S2, Franco)
- [ ] Mapa de tareas y primer recorte (Teo)
- [ ] Orientación elegida y objetivo de 60 días (S3, Facu)
- [ ] Piezas publicadas y calendario ajustado (talleres)
- [ ] **Creación de contenido aceitada** · condición para entrar al mes 2
- [ ] Arranque del frente (S4, Franco)
- [ ] Documento de punto A a punto B completo

**Meses 2 y 3** — se copian los cinco bloques, más el checklist propio de la orientación elegida.

**Cierre**
- [ ] Roadmap a 6 meses escrito
- [ ] Criterio de graduación evaluado
- [ ] Definido si es candidato a Nivel 3

> **A confirmar · Teo.** El recorrido de la sección 5 dice que los tres frentes del piso común caen en la semana 1. El calendario de la sección 9 los reparte en tres semanas y esta tabla sigue el calendario, que es lo que se está ejecutando. Unificar las tres.

---

## 7. Mapa de mentores

Se entrega en el onboarding y queda fijado en la comunidad. Es el activo más barato de producir y el que más sube el rendimiento de las sesiones.

| Mentor | Frente | Traele | No le traigas |
|---|---|---|---|
| Franco | Growth y monetización | Oferta, precio, ventas, escala, decisiones comerciales | Ejecución de piezas, herramientas |
| Facu | Estructura y gestión | Procesos, equipo, delegación, gerencia, prioridades | Creatividad, contenido |
| Fede | Contenido | Narrativa, ángulos, calendario, qué decir y cómo | Precio, estructura societaria |
...
| Artefacto | Cuándo | Origen |
|---|---|---|
| One-pager de oferta | Semana 2 | Sesión con Franco |
| Templates de oferta | Semana 2 | Sistemas internos |
| Proceso de ventas documentado | Semanas 7 y 8 | Sistemas internos |
| Estructura de entrega de servicio | Semanas 9 y 10 | Sistemas internos |
| Dashboard de métricas | Semana 12 | Backend adaptado |
| Roadmap a 6 meses | Última llamada | Sesión de cierre |
| Template de la orientación, con checklist | Semana 3 | Anexo de este documento |
| Acceso a publicar en Connect Wall | Permanente | Connect Wall |
| Agente IA | Permanente | En desarrollo |
| Biblioteca de libros, recursos y activos | Permanente | Biblioteca interna |

**Criterio de graduación.** Define qué significa completar el programa, y habilita dos cosas: el testimonio con número para el VSL de la camada siguiente, y la calificación al Nivel 3. Propuesta: one-pager de oferta ejecutado, proceso de ventas corriendo y facturación medida durante los últimos 30 días. Quien llega ahí y proyecta 30k mensuales a seis meses es candidato a Growth Partner.
...
| Scarlett Montilla | Conseguir | En ejecución. Restricción de trabajo full time |
| Lucio Labate | Conseguir | En ejecución. Punto B al 30 de septiembre |
| Agos Marchesini | *sin asignar* | Mes 1. Falta documento de recorrido |
| Matías Morales | *sin asignar* | Mes 1. Falta documento de recorrido |

Agos y Matías todavía no tienen roadmap asignado ni documento de punto A a punto B, que los otros cuatro sí tienen. Antes de la grupal unificada conviene emparejarlos, porque si no arrancan la cohorte con menos información sobre sí mismos que el resto.
...
| Sofía Galvis | Sí | Viene muy bien. Candidata a caso de la camada. Documentar el punto A antes de que arranque |

### Los que no entran a esta camada

| Cliente | Qué pasa |
|---|---|
| Antonio Mazzello | Extensión de 2 meses en el formato actual, para marcar un roadmap nuevo y cerrar |
| Andrea Saturno | Extensión de 2 meses en el formato actual, para marcar un roadmap nuevo y cerrar |
| Rafael y Matías · Qualita | Extensión de 2 meses en el formato actual, para marcar un roadmap nuevo y cerrar |
| MySaint · Tomás | Ya pasó a Growth Partner (Nivel 3) |
| Manu Bruzzone | Extensión de 1 mes. Se decide al cierre |
| Cecilia | Extensión de 1 mes. Se decide al cierre |
| Lucca Sorgoni | Upsell a 4.000. Propuesta aparte |
| Workflow · Lola | Sin clasificar. Falta el estado de la cuenta |

### Ocupación del cupo

Seis de Cáscara más tres de F3 son **nueve sobre dieciséis**. Quedan **siete lugares para venta abierta**, que es el margen que sostiene los pitches que se envían esta semana.

### Nivelación

Los tres que entran de F3 llegan con recorrido propio, sin el piso común de Cáscara. **Una sesión de nivelación comprimida en la primera semana**, con los tres frentes en formato condensado. El argumento de "todos hablando el mismo idioma" es el que sostiene el formato grupal; si parte de la sala no lo tiene, la grupal se vuelve una sucesión de explicaciones individuales.
...
**Sharon Palacio · orientación Entregar**
Ya demostró que ejecuta. Lo que le faltaba era un plan que pueda sostener sin correr detrás de cada oportunidad nueva. Trabaja con dos cuentas separadas: la personal con su voz estratégica y la de tatuaje, orgánica. El negocio de tatuaje quedó definido como ancla económica principal, con objetivo de 1,5 a 2 millones de pesos mensuales, y Studionet aparcado como proyecto de horizonte largo. Tiene tres clientes de estrategia activos. Su fuerte es la prolijidad y el orden, y ahí es donde más rinde.

**Ayelén Cerqueira · orientación Conseguir**
La oferta existía como capacidad, no como producto definido. Se ordenó en dos: Huella Digital, una asesoría de un mes, y una consultoría de tres meses como oferta principal. Apareció un ángulo de comunidad como diferencial propio, todavía por validar. Es la que tiene el pipeline más movido: Cósmico, Micaela Belén de Mika Yoga Holística, Ariel Machiadino, Yomar con propuesta enviada y Nico Donovan pendiente.

**Scarlett Montilla · orientación Conseguir**
El patrón es más específico que "le falta oferta": el trabajo llega excelente hasta el análisis y se corta justo antes de la propuesta. Tres founders distintos se lo marcaron con quince días de diferencia. Su mecanismo es la presencia multipotencial. Tiene una oportunidad tibia con Vero que se viene enfriando, y es la única de la camada con trabajo full time como QA tester, lo que condiciona cualquier objetivo que se le fije.

**Lucio Labate · orientación Conseguir**
Clientes propios desde 2017, con un rol que siempre fue más amplio que el diseño: dirección visual, contenido, edición y producción. Trabajó con indumentaria (4VX, Lee, Wrangler, Brooksfield), fintech, artistas y productoras. Su trabajo más completo fue 4VX, donde estuvo dos años y medio y dejó una identidad que sigue funcionando. Sus clientes llegaron por referidos y compraron entregables sueltos, lo que fijó el ticket entre 500 y 800 dólares. Hoy su ingreso viene de un contrato fijo en una empresa de ciberseguridad. Los tres pilares que definió son dirección creativa, multidisciplina y Mundo Luwel. El punto B es presentarse como estratega creativo, con cierre al 30 de septiembre y meta de cuatro clientes de ~800 dólares.

**Agos Marchesini** · *pendiente de resumen y roadmap*

**Matías Morales** · *pendiente de resumen y roadmap*

**Bianca Antonini** · *pendiente de resumen*

**Nicolás Lozada** · *pendiente de resumen*

**Sofía Galvis** · *pendiente de resumen* — es la candidata más clara a caso de la camada, así que conviene documentar su punto A antes de que arranque.

---

## 13. Operativa para Teo
...
1. Respuesta escrita a la objeción de frecuencia de 1-1 para los que vienen del Founder System.
2. Roadmap y documento de recorrido de Agos y Matías.
3. Resúmenes de punto A de Bianca, Nicolás y Sofía.
...
Meta: 10 tickets, mínimo viable 8.

| Fecha | Qué pasa | Dueño |
|---|---|---|
| Mié 19/8 | Naming cerrado · cuenta creada en privado | Franco |
| Jue 20 a dom 23/8 | Secuencia fija · onboarding grabado · mapa de mentores | Juana · Teo |
| Lun 24/8 | Cohorte 0 arranca · abren solicitudes · VSL v1 | Teo · Franco |
| Lun 31/8 | Tripwire: 120 personas adentro | Franco |
| Lun 31/8 | VSL v2 con los cinco · segunda ola de tráfico | Fede |
| Dom 6/9 | Cierre del micro-lanzamiento | Francisca |
| Mar 8/9 | La cuenta pasa a pública | Fede |
| Segunda semana de septiembre | Día 0 de la cohorte 1 | Teo |

**Quién comunica.** Franco es la única marca que argumenta la oferta. Fede, Juana y Teo avalan con una pieza desde su rol. Facu no comunica en esta ventana. Los anuncios en comunidades van al segmento de graduados, no al canal general, para no competir con el workshop del Nivel 1.

**Comercial.** Audio de opener de Franco explícitamente de uno a muchos. Francisca califica contra el filtro de admisión y agenda con Franco solo lo que pasa el filtro.

**Todo el lanzamiento corrió una semana** respecto de la versión anterior. La ventana de venta pasa a ser del 24 de agosto al 6 de septiembre, la cuenta se hace pública el 8 y la cohorte 1 arranca la segunda semana de septiembre.

**Falta resolver la relación entre las dos cohortes.** El calendario de la sección 9 corre del 20 de agosto al 7 de octubre con las grupales de la camada actual, y esta tabla dice que la cohorte 1 arranca recién la segunda semana de septiembre. O ese calendario es de la cohorte 0 y hay que armar el de la 1, o son una sola camada y hay que unificar el nombre.

---

## 15. Cómo se comunica hacia afuera

**A los que entran.** Un mensaje único, no uno por cliente. El programa mejora: mantienen el trabajo de negocio y suman contenido, creatividad, operaciones y el resto de la cohorte trabajando en paralelo. Hacia el cliente no existe ninguna fusión: es un solo producto que crece.

**A los que extienden.** Continuidad normal, sin mención de la fusión. La conversación de qué sigue se da al cierre de la extensión.

**A los que suben.** Propuesta propia por cliente. No se mezcla con la comunicación de la cohorte.
...
| Punto | Estado |
|---|---|
| Resúmenes de punto A pendientes | Agos, Matías, Bianca, Nicolás, Sofía |
| Orientación de Agos y Matías | Sin asignar |
| Contrato propio de la Aceleradora | No existe. Se está usando el del B2C. Escribirlo antes de la primera camada vendida |
| Onboarding automático | Definir herramienta y si el contrato va dentro del flujo de pago |
| App de Cáscara | Qué tiene que estar listo para la primera camada vendida |
| Coordinador · CSM | Cuándo se abre el rol y con qué disparador. Unificar con los acuerdos vigentes |
| Registro de grupales | Dónde vive y quién lo carga. Sin registro, el protocolo de coordinación no se puede cumplir |
| Página de la Aceleradora | La versión publicada quedó desactualizada: cruza los roles de Facu y Franco y usa seis frentes en vez de los cinco bloques. Se reescribe con este documento antes de compartirla |
| Grabación de la rotación de grupales | Si se graba para el que entra tarde. Toca el argumento de exclusividad |
| Agente IA | Qué se construye con Coderhouse, qué queda propio, y si entra en esta camada o en la siguiente |
| Cruce con el documento de Cáscara | Ver qué material de los roadmaps A, B y C se reutiliza |
| El vocabulario de evergreen y la división de grupales y 1-1 | Teo confirma y se reescribe la sección 5 |
| Cohorte 0 y cohorte 1 | Definir si son dos camadas o una. El calendario de la sección 10 y la tabla de lanzamiento no coinciden |
| Modelo de conducta | Escribirlo con números concretos antes del próximo onboarding |
| Criterio de graduación | Propuesta hecha en la sección 8. Sin confirmar |
| Rol de Facu en la oferta | Participa más de lo que el documento le asigna hoy |
| Fecha de apertura de la camada | Sin definir. Bloquea el pitch |
| Workflow · Lola | Sin clasificar |
| Calendario propio de Teo | Sin compartir. Confirmar antes de mandar invitaciones |
...
**Objetivo de 60 días.** Primeros cierres con el sistema nuevo.
**Métrica que se mira.** Propuestas enviadas y cierres.

**Oferta y precio**
- [ ] **Promesa escrita en una línea, sin adjetivos**
- [ ] **Mecanismo propio nombrado y explicado en tres pasos**
- [ ] **Entregables listados con tiempo de entrega de cada uno**
- [ ] **Precio definido, con plan de pagos**
- [ ] **Dos niveles: uno de entrada y el principal**
- [ ] Condiciones de trabajo escritas: qué incluye, qué no, cuántas revisiones

**Adquisición y ventas**
- [ ] **Lista de 50 prospectos con criterio, no con voluntad**
- [ ] **Guion de primer contacto, probado en 10 envíos**
- [ ] **20 conversaciones abiertas**
- [ ] **Guion de discovery con las preguntas que califican**
- [ ] **5 discovery grabadas y revisadas**
- [ ] **Estructura de propuesta, con Loom**
- [ ] **5 propuestas enviadas**
- [ ] **Objeciones listadas con su respuesta escrita**
- [ ] **Guion de cierre propio, salido de sus llamadas**
- [ ] **Pipeline con etapas, fechas y números**

**Contenido y audiencia**
- [ ] Calendario corriendo, sostenido tres semanas seguidas
- [ ] Una pieza por semana que hable de la oferta

**Entrega del servicio**
- [ ] Proceso de entrega en una página, listo para el primer cliente que cierre
- [ ] Documento de inicio de cliente: qué necesita, cuándo, de quién

**Estructura, capacidad y números**
- [ ] Tablero con propuestas enviadas, cierres y cash cobrado
- [ ] Cuántos clientes puede sostener hoy sin romper la entrega

**Hitos**
- [ ] Día 30 · oferta escrita con precio
- [ ] Día 45 · primeras propuestas enviadas
- [ ] Día 60 · primer cierre con el sistema nuevo
- [ ] Día 90 · pipeline corriendo y clientes cerrados

---

### Sostener

**Objetivo de 60 días.** Ritmo de contenido sostenido que genere consultas sin depender de su energía.
**Métrica que se mira.** Piezas publicadas y consultas entrantes.

**Contenido y audiencia**
- [ ] **Línea editorial escrita: de qué habla, de qué no, con qué voz**
- [ ] **Tres ángulos propios definidos, con ejemplos de cada uno**
- [ ] **Calendario a 60 días cargado**
- [ ] **Templates de los formatos que más le rinden**
- [ ] **Banco de ideas con al menos 30 entradas**
- [ ] **Cuatro semanas de publicación sostenida sin frenar**
- [ ] **Una pieza por semana que lleve a una conversación**
- [ ] **Métricas de contenido revisadas cada semana, no cada mes**

**Estructura y equipo**
- [ ] **Mapa de tareas de producción, con horas propias por pieza**
- [ ] **Qué se delega primero, escrito y priorizado**
- [ ] **Búsqueda publicada en Connect Wall**
- [ ] **Primer editor o asistente incorporado**
- [ ] **Checklist de revisión propio, para que el trabajo delegado vuelva bien**
- [ ] **Proceso de trabajo con el editor documentado**

**Oferta y precio**
- [ ] Oferta escrita con precio, aunque no se toque en estos 60 días
- [ ] Un llamado a la acción claro y siempre el mismo

**Adquisición y ventas**
- [ ] Proceso de qué pasa cuando llega una consulta, escrito
- [ ] Guion de discovery, aunque sea corto

**Entrega del servicio**
- [ ] Proceso de entrega en una página
- [ ] Documento de inicio de cliente

**Hitos**
- [ ] Día 30 · línea editorial y calendario cargado
- [ ] Día 45 · cuatro semanas publicadas sin frenar
- [ ] Día 60 · primera persona incorporada al equipo
- [ ] Día 90 · el contenido sale con él fuera de la producción

---

### Entregar

**Objetivo de 60 días.** Entregar el mismo servicio con menos horas propias.
**Métrica que se mira.** Horas propias por cliente y margen.

**Entrega del servicio**
- [ ] **Mapa del servicio actual, con tiempos reales medidos, no estimados**
- [ ] **Proceso de entrega documentado paso a paso**
- [ ] **Qué hace el cliente y qué hace él, separado y escrito**
- [ ] **Documento de inicio de cliente con expectativas y plazos**
- [ ] **Informe inicial e informe final: templates de punto A y punto B**
- [ ] **Puntos de control del servicio: cuándo se revisa y contra qué**
- [ ] **Los tres problemas que más se repiten, con su respuesta armada**

**Estructura, capacidad y números**
- [ ] **Roles de la entrega definidos: quién hace qué**
- [ ] **Qué se delega primero, escrito y priorizado**
- [ ] **Búsqueda publicada en Connect Wall**
- [ ] **Primera persona incorporada a la entrega**
- [ ] **Cupo definido: cuántos clientes entran por mes**
- [ ] **Precio recalculado contra el costo real de entrega**
- [ ] **Tablero con horas por cliente y margen por cliente**
- [ ] **Conversación de renovación armada, con cuándo se da**

**Oferta y precio**
- [ ] Oferta ordenada en niveles, con el precio nuevo
- [ ] Qué deja de hacer, escrito y comunicado

**Adquisición y ventas**
- [ ] Proceso de qué pasa cuando llega una consulta, escrito
- [ ] Lista de espera activa si el cupo está lleno

**Contenido y audiencia**
- [ ] Calendario corriendo, sostenido tres semanas seguidas
- [ ] Una pieza por semana que muestre el servicio funcionando

**Hitos**
- [ ] Día 30 · mapa del servicio con tiempos reales
- [ ] Día 45 · proceso documentado y primera búsqueda publicada
- [ ] Día 60 · primera persona incorporada a la entrega
- [ ] Día 90 · cupo y precio nuevos corriendo, con margen medido
...
## Copy de la oferta (para el pitch, que se diseña aparte)

> **Aceleradora · cohorte cerrada**
> **Cáscara Aceleradora**
> **USD 3.500** · 4.000 en cuotas
>
> 90 días con los founders metidos adentro de tu negocio real. El oficio se vuelve negocio: oferta que se cobra bien, sistema de cierre repetible y estructura que no depende de vos en cada entrega.

---

*Cáscara Collective · documento interno · versión 10*
